...
class _$HomeModelImpl extends _HomeModel {
  const _$HomeModelImpl({required this.id, this.data}) : super._();
  ...
  @override
  String toString() {
    return 'HomeModel(id: $id, data: $data)';
  }
...
abstract class _HomeModel extends HomeModel {
  const factory _HomeModel({required final String id, final String? data}) =
      _$HomeModelImpl;
